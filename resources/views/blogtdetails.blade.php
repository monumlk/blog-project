        ...
        <div class="col-md-4">
            <div>
                ...
                <div class="input-group flex-nowrap">
                    <input type="text" name="query" class="form-control search-form" placeholder="Search" aria-label="Username"
        ...
        <div class="col-md-2">
            ...
            @else
                <a href="{{route('createpost')}}"
                    style="background-color:white;color:grey;font-weight:600;" 
                    class="btn btn-primary bg-white text-grey"
                >
                    +Sell Mobile
                </a>
    ...
    <div class="container mt-2">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card-body">
                    <div><img style=" max-height:300px; width:auto;" src="/postimage/{{ $blog->image }}"
                            class="services_img "></div>
                    <h4 class="text-center font-weight-bold text-xl my-2">{{ $blog->title }}</h4>
                    <p class="text-lg text-justify mb-5">{{ $blog->description }}</h5>    
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                @if (auth()->check() && auth()->id() == $comment->user->id)
                                    <a class="btn btn-danger mt-4" href="{{url('/commentdelete',$comment->id)}}">Delete</a>
                                @endif
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row bg-light mt-4">
                ...
                <div class="col-md-4 mt-2">
                    <p>All rights reserved ©2024 ELX</p>
                </div>
                <div class="col-md-4">
